...
class GenericPlaylistFragment : MyFragment() {
    ...
    companion object {
        @JvmStatic
        fun newInstance(): GenericPlaylistFragment { //todo setup so can pass value
    ...
    */
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
        ...
        _view = inflater.inflate(R.layout.fragment_latest_playlist, container, false) //todo I need to change this or can I use this fragment
    ...
    private fun processNavigation(item: MenuItem) {
        ...
        if (item.itemId == R.id.bm_refresh) {
            ...
            flipNoDataMessage()
            _viewAdapter.notifyDataSetChanged() //todo should clear with adapter filled
        }
    }
